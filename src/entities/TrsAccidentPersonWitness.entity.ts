...
@Index("PK__trs_acci__3213E83F6AD160AF", ["id"], { unique: true })
@Entity("trs_accident_person_witness", { schema: "dbo" })
export class trsAccidentPersonWitness {
  ...
  //     trs_accident_activity_form.trs_accident_person_witnesses,
  //   { onDelete: "SET NULL" }
  // )
