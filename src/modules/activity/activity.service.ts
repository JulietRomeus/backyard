...
const convoyVehicleDriverFields = `convoy.vehicle_driver.id,convoy.vehicle_driver.controller,convoy.vehicle_driver.oil_type,convoy.vehicle_driver.oil_coupon,convoy.vehicle_driver.vehicle_license,convoy.vehicle_driver.oil,convoy.vehicle_driver.vehicle_item_id,convoy.vehicle_driver.vehicle_supply_id,convoy.vehicle_driver.before_activity_form.*,convoy.vehicle_driver.help_activity_form.*,convoy.vehicle_driver.after_activity_form.*,convoy.vehicle_driver.lat,convoy.vehicle_driver.long,convoy.vehicle_driver.client_id,convoy.vehicle_driver.last_location_date,${convoyVehicleFields},${convoyDriverFields}`;
